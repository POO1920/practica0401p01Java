...
public class TestsMatricula {
	...
	public void testPrecioFamiliaNoNumerosaPrimeraMatricula() {
		...
		Matricula m1 = new Matricula(act1, est1, Curso.C1920,OrdenMatricula.M1,21.21);
		Matricula m2 = new Matricula(act2, est1, Curso.C2021,OrdenMatricula.M1,10);
		Matricula m3 = new Matricula(act3, est1, Curso.C2021,OrdenMatricula.M1,10);
	...
	public void testPrecioFamiliaNoNumerosaSegundaMatricula() {
		...
		Actividad act3 = new Convalidacion("TP", 6, "Tecnologia Programacion", "Universidad Zaragoza");
		Estudiante est1 = new Estudiante("peperez",false);
		Matricula m1 = new Matricula(act1, est1, Curso.C1920,OrdenMatricula.M2,21.21);
		Matricula m2 = new Matricula(act2, est1, Curso.C2021,OrdenMatricula.M2,10);
		Matricula m3 = new Matricula(act3, est1, Curso.C2021,OrdenMatricula.M1,10);
	...
	public void testPrecioFamiliaNoNumerosaTerceraMatricula() {
		...
		Actividad act2 = new Reconocimiento("Deportes", 2, "Campeonatos universitarios");
		Estudiante est1 = new Estudiante("peperez",false);
		Matricula m1 = new Matricula(act1, est1, Curso.C1920,OrdenMatricula.M3,21.21);
		Matricula m2 = new Matricula(act2, est1, Curso.C2021,OrdenMatricula.M3,10);
			
		assertEquals("Precio familia no numerosa, tercera de asignatura matricula es precio por nº créditos por 4",509.04, m1.getPrecio(),0.0001);
		assertEquals("Precio familia no numerosa, tercera matricula de reconocimiento es precio por nº créditos por 4 por 0.75",60, m2.getPrecio(),0.0001);
	...
	public void testPrecioFamiliaNoNumerosaCuartaMatricula() {
		...
		Actividad act2 = new Reconocimiento("Deportes", 2, "Campeonatos universitarios");
		Estudiante est1 = new Estudiante("peperez",false);
		Matricula m1 = new Matricula(act1, est1, Curso.C1920,OrdenMatricula.M4,21.21);
		Matricula m2 = new Matricula(act2, est1, Curso.C2021,OrdenMatricula.M4,10);
	...
	public void testPrecioFamiliaNumerosa() {
		...
		Matricula m1 = new Matricula(act1, est1, Curso.C1920,OrdenMatricula.M1,21.21);
		Matricula m2 = new Matricula(act2, est1, Curso.C2021,OrdenMatricula.M2,10);
		Matricula m3 = new Matricula(act3, est1, Curso.C1920,OrdenMatricula.M3,21.21);
		Matricula m4 = new Matricula(act4, est1, Curso.C2021,OrdenMatricula.M4,10);
		Matricula m5 = new Matricula(act5, est1, Curso.C2021,OrdenMatricula.M1,10);
			
		assertEquals("Precio familia numerosa, primera matricula de asignatura es precio por nº créditos por 0.5 ",63.63, m1.getPrecio(),0.0001);
		assertEquals("Precio familia numerosa, segunda matricula de reconocimiento es precio por nº créditos por 2 por 0.5 por 0.75",15, m2.getPrecio(),0.0001);
		assertEquals("Precio familia numerosa, tercera matricula de asignatura es precio por nº créditos por 4 por 0.5",212.10, m3.getPrecio(),0.0001);
		assertEquals("Precio familia numerosa, cuarta matricula de reconociemiento es precio por nº créditos por 6 por 0.5 por 0.75",90, m4.getPrecio(),0.0001);
		assertEquals("Precio familia numerosa, primera matricula convalidación, es precio por nº créditos por 0.5 por 0.5",15, m5.getPrecio(),0.0001);
	...
	public void testAprobadoSuspenso() {
		...
		Matricula m2 = new Matricula(act1, est1, Curso.C1920,OrdenMatricula.M3,21.21);
		...
		Matricula m3 = new Matricula(act1, est1, Curso.C1920,OrdenMatricula.M3,21.21);
	...
	public void testEqual() {
		...
		Matricula m2 = new Matricula(act1, est1, Curso.C2021,OrdenMatricula.M3,21.21);
		Matricula m3 = new Matricula(act1, est1, Curso.C2021,OrdenMatricula.M2,10);
		Matricula m4 = new Matricula(act1, est1, Curso.C2021,OrdenMatricula.M3,21.21);
